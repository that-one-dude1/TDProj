...
namespace TDProj
{
    public class Game1 : Game
    {
        ...
        protected override void LoadContent()
        {
            ...
            background = Content.Load<Texture2D>("Backgrounds/plains-background");
            menuBackground = Content.Load<Texture2D>("Backgrounds/menu-background");
            instructionsBackground = Content.Load<Texture2D>("Backgrounds/instructions-background");
            ...
            var triangle = Content.Load<Texture2D>("Sprites/triangle");
            var pentagon = Content.Load<Texture2D>("Sprites/pentagon");
            var hexagon = Content.Load<Texture2D>("Sprites/hexagon");
