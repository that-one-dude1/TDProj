...
namespace TDProj
{
    public class Tower
    {
        ...
        private void FireAt(Enemy target)
        {
            ...
            float timeToReach = dist / 400f;
            Vector2 predictedPosition = target.position + target.Velocity * timeToReach;

            projectiles.Add(new Projectile(position, predictedPosition, speed: 400f, damage: def.Damage, texture));
        }
